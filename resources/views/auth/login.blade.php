...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card text-light" style="background-color: black !important;">
                        <div class="card-header" style="border-color: white !important;"><h3>{{ __('Inicia Sesión') }}</h3></div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="alguien@example.com" required autocomplete="email" autofocus>
    ...
    <footer class="f-cust">
            ...
            <div class="secciones col-12 col-sm-6 col-md-3">
                ...
                <div class="col-6">             
                <a href="#" class="link-f">Tecnología</a>
                <a href="#" class="link-f">Videojuegos</a>
