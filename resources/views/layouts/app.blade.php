...
<body>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark" style="background-color: black !important;">            
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">                   
                  <ul class="navbar-nav mr-auto mt-2 mt-lg-0 listado">
                    ...
                    @else
                        <li class="nav-item">                                                                                            
                            <a class="nav-link" href="{{route('userposts.index')}}">TECNOLOGÍA / </a>                        
                        </li>
                        <li class="nav-item">                                                
                            <a class="nav-link" href="{{route('userpostsvj.index')}}">VIDEOJUEGOS / </a>                        
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">ESPORTS </a>
                        </li>
    ...
    <footer>
            ...
            <div class="secciones col-12 col-sm-6 col-md-3">
                ...
                @else
                    <a href="{{route('userposts.index')}}" class="link-f">Tecnología</a>
                    <a href="{{route('userpostsvj.index')}}" class="link-f">Videojuegos</a>
                    <a href="#" class="link-f">Esports</a>
                @endif
                </div>
            </div>      
